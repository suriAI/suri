...
class SCRFD:
    ...
    def __init__(
        ...
        Args:
            ...
            input_size (Tuple[int]): Input image size. Defaults to (640, 640)
            conf_thres (float): Confidence threshold. Defaults to 0.5.
            iou_thres (float): Non-max suppression (NMS) threshold. Defaults to 0.4.
        """
    ...
    def _initialize_model(self, model_path: str):
        ...
        try:
            ...
            print(f"Failed to load SCRFD model: {e}")
            raise

    def forward(self, image, threshold):
        """Forward pass through the SCRFD model."""
        scores_list = []
        bboxes_list = []
        kpss_list = []
